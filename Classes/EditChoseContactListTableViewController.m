//
//  EditChoseContactListTableViewController.m
//  GULUAPP
//
...
@implementation EditChoseContactListTableViewController
...
- (void)tableView:(UITableView *)tableview didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	NSMutableDictionary *dict1=[appDelegate.temp.inviteObj.contactDict objectForKey:[dict  objectForKey:@"id"]];
	
	if([dict1 objectForKey:@"alreadyIn"])
	{
		return;
	}
