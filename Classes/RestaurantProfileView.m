...
@implementation RestaurantProfileView
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) 
	{
		...
		titleLabel=[[UILabel alloc] initWithFrame:CGRectMake(120, 0 ,200 , 20)];
		...
		follwersLabel=[[UILabel alloc] initWithFrame:CGRectMake(120,80 ,90 , 20)];
		[self addSubview:follwersLabel];
		[follwersLabel release];
				
		reviewsLabel=[[UILabel alloc] initWithFrame:CGRectMake(120,100 ,90 , 20)];
		[self addSubview:reviewsLabel];
		[reviewsLabel release];
	
		
		follwersNumberLabel=[[UILabel alloc] initWithFrame:CGRectMake(210,80 ,20 , 20)];
		[self addSubview:follwersNumberLabel];
		[follwersNumberLabel release];
		
		reviewsNumberLabel=[[UILabel alloc] initWithFrame:CGRectMake(210,100 ,20 , 20)];
		[self addSubview:reviewsNumberLabel];
		[reviewsNumberLabel release];
		
		guluapproveImageView=[[UIImageView alloc] initWithFrame:CGRectMake(245, 85 ,70 , 30)];
