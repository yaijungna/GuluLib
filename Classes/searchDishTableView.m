...
@implementation searchDishTableView
...
- (void)tableView:(UITableView *)tableview didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [GuluNavigationManager gotoDishProfile:self.navigationController dish:[tableArray objectAtIndex:indexPath.row]];
}
