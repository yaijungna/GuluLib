...
@implementation pickSpectatorViewController
...
-(void)initViewController
{
    ...
    titleLabel.text=@"Pick Spectators!.";
...
- (void)backAction 
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"addSpectatorsNotification" object:nil];
...
- (void)tableView:(UITableView *)tableview didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if(((ACTableOneLineWithImage_Checkbox_Cell *)cell).checkBox.selected==YES)
	{
		...
		[missionObj.spectatorDict removeObjectForKey:[dict objectForKey:@"id"]];
		
	}
	else
	{
		((ACTableOneLineWithImage_Checkbox_Cell *)cell).checkBox.selected=YES;
		[missionObj.spectatorDict setObject:dict forKey:[dict objectForKey:@"id"]];
