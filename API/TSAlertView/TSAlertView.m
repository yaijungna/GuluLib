...
const CGFloat kTSAlertView_LeftMargin	= 20.0;
const CGFloat kTSAlertView_TopMargin	= 30.0;
const CGFloat kTSAlertView_BottomMargin = 15.0;
const CGFloat kTSAlertView_RowMargin	= 20.0;
...
- (UILabel*) titleLabel
{
	if ( _titleLabel == nil )
	{
        ...
        _titleLabel.font = [UIFont fontWithName:FONT_BOLD size:18];
...
- (UILabel*) messageLabel
{
	if ( _messageLabel == nil )
	{
        ...
        _messageLabel.font = [UIFont fontWithName:FONT_NORMAL size:16];
		_messageLabel.backgroundColor = [UIColor clearColor];
		//_messageLabel.textColor = [UIColor whiteColor];
        _messageLabel.textColor =TEXT_COLOR;
...
- (UIImage*) backgroundImage
{
	if ( _backgroundImage == nil )
	{
        ...
        self.backgroundImage = [[UIImage imageNamed: @"pop-up-1.png"] stretchableImageWithLeftCapWidth: 0 topCapHeight: 00];
...
- (void) setCancelButtonIndex:(NSInteger)buttonIndex
{
	...
	UIImage* buttonBgNormal = [UIImage imageNamed: @"button-1.png"];
...
- (NSInteger) addButtonWithTitle: (NSString *) t
{
    ...
    [b.titleLabel setFont:[UIFont fontWithName:FONT_NORMAL size:14]];
	...
	UIImage* buttonBgPressed = [UIImage imageNamed: @"TSAlertViewButtonBackground_Highlighted.png"];
//    UIImage* buttonBgPressed = [UIImage imageNamed: @"button-1.png"];
	buttonBgPressed = [buttonBgPressed stretchableImageWithLeftCapWidth: buttonBgPressed.size.width / 2.0 topCapHeight: buttonBgPressed.size.height / 2.0];
	[b setBackgroundImage: buttonBgPressed forState: UIControlStateHighlighted];
...
- (CGSize) recalcSizeAndLayout: (BOOL) layout
{
	...
	if ( layout )
	{
		...
		if ( stacked )
		{
		//	CGFloat buttonWidth = maxWidth;  //alan
			for ( UIButton* b in self.buttons )
			{
				//b.frame = CGRectMake( kTSAlertView_LeftMargin, y, buttonWidth, buttonHeight );
                b.frame = CGRectMake(  self.center.x-50, y, 90 , 40 ); // alan
				[self addSubview: b];
		...
		else
		{
			...
			{
                if(ii==0)
                    b.frame = CGRectMake( x+10, y, buttonWidth-10 , 40 ); // alan
                else
                    b.frame = CGRectMake( x, y, buttonWidth-10 , 40 ); // alan
